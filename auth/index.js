...
router.post('/newjob', (req, res, next) => {
    ...
    //             //this is a unique trip
                    const job = {
                        ...
                        loading_attended : 'No',
                        unloading_attended : 'No',
                        lump_sum_amount : req.body.lump_sum_amount,
                        lump_sum_sent : req.body.lump_sum_sent,
                        lump_sum_invoiced : req.body.lump_sum_invoiced,
                        proforma_amount : '0',
                        proforma_sent : 'unsent',
            ...
            if(!job) {
                //this is a unique trip
                    const job = {
                        ...
                        contract_signed : req.body.contract_signed,
                        kickoff_meeting : req.body.kickoff_meeting,
                        loading_attended : req.body.loading_attended,
                        unloading_attended : req.body.unloading_attended,
                        lump_sum_amount : req.body.lump_sum_amount,
                        lump_sum_sent : req.body.lump_sum_sent,
                        lump_sum_invoiced : req.body.lump_sum_invoiced,
                        proforma_amount : req.body.proforma_amount,
                        proforma_sent : req.body.proforma_sent,
                        proforma_invoiced : req.body.proforma_invoiced,
                        barge_name : req.body.barge_name,
                        tug_name : req.body.tug_name,
                        est_start_date : req.body.est_start_date,
                        ord_notes : req.body.ord_notes,
